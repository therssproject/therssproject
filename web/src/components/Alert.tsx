...
export const Alert = ({children, variant = 'info', onDismiss, className}: Props) => {
  ...
  return (
    ...
    >
      <div className={clsxm('space-y-2 p-4', text)}>
        {children}
      </div>
      {onDismiss ? (
        <button type="button" className="absolute top-3 right-3" onClick={onDismiss}>
