...
type PricingTerm = 'month' | 'year';

export const Pricing = () => {
  const [pricingTerm, setPricingTerm] = useState<PricingTerm>('month');
    ...
    <div className="bg-gray-50">
      <div className="relative bg-gradient-to-r from-teal-500 to-cyan-600">
        ...
        <div className="relative mt-12 flex justify-center sm:mt-16">
          <div className="flex rounded-lg bg-teal-700 p-0.5">
            <button
              type="button"
              onClick={() => setPricingTerm('month')}
              className={clsxm(
                'relative whitespace-nowrap rounded-md py-2 px-6 text-sm font-medium',
                'focus:z-10 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-teal-700',
                pricingTerm === 'month'
                  ? 'border-teal-700 bg-white text-teal-700 shadow-sm'
            ...
            <button
              type="button"
              onClick={() => setPricingTerm('year')}
              className={clsxm(
                'ml-0.5',
                'relative whitespace-nowrap rounded-md border py-2 px-6 text-sm font-medium',
                'focus:z-10 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-teal-700',
                pricingTerm === 'year'
                  ? 'border-teal-700 bg-white text-teal-700 shadow-sm'
                  : 'border-transparent text-teal-200',
        ...
        <div className="relative mx-auto mt-8 max-w-2xl px-4 pb-8 sm:mt-12 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-0">
          ...
          <div
            aria-hidden="true"
            className="absolute inset-0 top-4 bottom-6 left-8 right-8 hidden rounded-tl-lg rounded-tr-lg bg-teal-700 lg:block"
          />
          ...
          <div className="relative space-y-6 lg:grid lg:grid-cols-3 lg:space-y-0">
            {plans.map((plan) => (
              <div
                ...
                className={clsxm(
                  plan.featured
                    ? 'bg-white shadow-md ring-2 ring-teal-700'
                ...
                <ul
                  ...
                  className={clsxm(
                    plan.featured
                      ...
                      : 'divide-teal-500 divide-opacity-75 border-teal-500',
            ...
            <div key="plan.title" className="border-t border-gray-200">
              ...
              <div className="relative mt-6">
                ...
                <div
                  className={clsxm(
                    plan.featured
                      ? 'shadow-md ring-2 ring-teal-600'
        ...
        <div className="mx-auto max-w-7xl py-24 px-8">
          ...
          <div className="relative">
            ...
            >
              ...
              <div className="w-1/4 px-4">
                <div className="h-full w-full rounded-lg ring-2 ring-teal-600 ring-opacity-100" />
              </div>
              <div className="w-1/4 pl-4">
                <div className="h-full w-full rounded-lg ring-1 ring-black ring-opacity-5" />
              </div>
